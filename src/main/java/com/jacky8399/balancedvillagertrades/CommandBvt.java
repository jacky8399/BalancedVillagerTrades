            ...
            if (args[0].equalsIgnoreCase("reload")) {
                ...
                if (args.length >= 4) {
                    try {
                        ...
                        wrapper = new TradeWrapper(villager, villager.getRecipe(recipeId), recipeId);
                    } catch (NumberFormatException | IndexOutOfBoundsException e) {
                        sender.sendMessage(ChatColor.RED + "Invalid recipe index " + args[3]);
                        return true;
                    }
                } else {
                    wrapper = new TradeWrapper(villager, null, -1);
                }
                ...
                case 3: {
                    try {
                        ...
                        if (entities.size() == 1 && entities.get(0) instanceof Villager) {
                            return new ArrayList<>(Fields.listFields(null, null, new TradeWrapper((Villager) entities.get(0), null, -1)).keySet());
                        }
